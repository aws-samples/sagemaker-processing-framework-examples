...
try:
    ...
    # Store annotations for next experiments
    # This might be just the first in a series of experiments for training a deep learning model with image data.
    # In order to make sure your work carries over to subsequent experiment, 
    # you will create a folder called pickled_data which will store your dataset annotations and asset names.
    '''
    pickled_dir = tmp_dir / "pickled_data"
